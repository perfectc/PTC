...
#if defined(NDEBUG)
# error "PTC cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PTC Signed Message:\n";
...
{
    int64_t nSubsidy = 0 * COIN;//IPO_SHARE/Params().LastPOWBlock();
